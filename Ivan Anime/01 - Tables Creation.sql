...
CREATE TABLE "Двигатель" ( 
	"№ Записи" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	"Объем" VARCHAR(30),
...
CREATE TABLE "Колесо" ( 
	"№ Записи" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	"№ Дисков" BIGINT,
	CONSTRAINT "ВК_Колесо_Диски" FOREIGN KEY("№ Дисков") REFERENCES "Диски"("№ Записи"),
	"№ Шин" BIGINT, 
	CONSTRAINT "ВК_Колесо_Шины" FOREIGN KEY("№ Шин") REFERENCES "Шины"("№ Записи"),
	"Диаметр" INT
);
...
CREATE TABLE "Авто" ( 
	...
	"№ Двигателя" BIGINT,
	CONSTRAINT "FK_Авто_Двигатель" FOREIGN KEY("№ Двигателя") REFERENCES "Двигатель"("№ Записи"),
	"№ Колёс" BIGINT, 
	CONSTRAINT "ВК_Авто_Колесо" FOREIGN KEY("№ Колёс") REFERENCES "Колесо"("№ Записи"),
	"№ КПП" BIGINT,
	CONSTRAINT "ВК_Авто_КПП" FOREIGN KEY("№ КПП") REFERENCES "КПП"("№ Записи"),
...
CREATE TABLE "Дов-сть авто" ( 
	...
	"Дата выдачи" TIMESTAMP, 
	"Кем выдана" BIGINT,
	CONSTRAINT "ВК_Дов-ть авто_Продавец" FOREIGN KEY("Кем выдана") REFERENCES "Продавец"("№ Записи"),
	"Срок действия" INT
);
...
CREATE TABLE "Координаты" ( 
	"№ Записи" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	CONSTRAINT "ВК_Координаты_Продавец" FOREIGN KEY("№ Записи") REFERENCES "Продавец"("№ Записи"),
	"Email" VARCHAR(40), 
	"Мобильный телефон" VARCHAR(17), 
	"Город" VARCHAR(100), 
	"Улица" VARCHAR(100), 
...
CREATE TABLE "РПДС" (                 -- Расписка о получении денежных средств
	"№ Записи" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
	"Кому выдана" BIGINT,
	CONSTRAINT "ВК_РПДС_Продавец" FOREIGN KEY("Кому выдана") REFERENCES "Продавец"("№ Записи"),
	"Сумма" INT
);
...
CREATE TABLE "Договор" (
	...
	"№ Продавца" BIGINT,
	CONSTRAINT "ВК_Договор_Продавец" FOREIGN KEY("№ Продавца") REFERENCES "Продавец"("№ Записи"),
	"№ Сотрудника" BIGINT, 
...
INSERT INTO public."Договор" ("№ Доверенности", "№ Продавца", "№ Сотрудника", "Номер авто", "Бухгалтер", "ПТС", "СТС", "Дата сделки") VALUES
	(1, 2, 1, 'У369НС', 3, 'WV5UX4AQ5Z5MESC', '7819512974', '2019-03-27'),
	(2, 4, 4, 'Р259ВС', 1, '47RE0EKN1HGPXM8', '0173074645', '2020-11-20'),
	(3, 5, 3, 'М411ЖА', 2, 'ETNYLEUI8MV7IEA', '6386230905', '2021-01-25'),
	(4, 1, 4, 'Н451ХМ', 2, 'H03YXNRQN6BHEUV', '7625964843', '2018-09-12'),
	(5, 3, 2, 'Е275ТС', 1, '5NM03K3I5IJCR75', '8356234602', '2020-03-21'),
	(6, 4, 2, 'С364ТО', 1, 'KYWJ4XNFR5KXM0R', '2362343426', '2012-07-16'),
	(7, 2, 1, 'Р199ВН', 3, 'IO9KVUIKJESVQEQ', '0451501636', '2019-01-31'),
	(8, 5, 4, 'Х202КВ', 1, 'F891P8KPW7SR892', '8782349472', '2015-04-24');